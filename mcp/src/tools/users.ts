...
export default [
  {
    name: "list_users",
    description: "Lista todos los usuarios registrados (requiere JWT + rol admin)",
    handler: async () => api.get("/users"),
  },
  {
    name: "update_user_role",
    description: "Cambia el rol de un usuario; no se puede cambiar el propio rol ni degradar al único admin (requiere JWT + rol admin)",
