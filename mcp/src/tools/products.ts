...
export default [
  ...
  {
    name: "get_product",
    description: "Obtiene un producto por su ID, incluyendo su categoría completa",
    inputSchema: { id: z.number().int() },
    handler: async ({ id }: any) => api.get(`/products/${id}`),
  },
  {
    name: "create_product",
    description: "Crea un nuevo producto (requiere JWT + rol admin)",
    inputSchema: {
  ...
  {
    name: "update_product",
    description: "Actualiza un producto existente, todos los campos opcionales (requiere JWT + rol admin)",
    inputSchema: {
      id: z.number().int(),
  ...
  {
    name: "delete_product",
    description: "Elimina un producto existente (requiere JWT + rol admin)",
    inputSchema: { id: z.number().int() },
